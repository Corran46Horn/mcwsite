    ...
    <div class="row">
      <div class="col col-6 col-lg-6">
        <a href="https://www.klubmil.pl/" class="site-wrap kmil" target="_blank">
          <img class="placeholder d-none d-lg-block" src="<?php echo get_template_directory_uri(); ?>/images/logoklub.png" alt="logo Klub Muzyki i Literatury we Wrocławiu">
          <div class="text-wrap">
      ...
      <div class="col col-6 col-lg-6">
        <a href="https://biblioteka.wroc.pl" class="site-wrap lib" target="_blank">
          <img class="placeholder d-none d-lg-block" src="<?php echo get_template_directory_uri(); ?>/images/biblioteka.svg" alt="logo Miejska Biblioteka Publiczna im. Tadeusza Różewicza we Wrocławiu">
          <div class="text-wrap">
      ...
      <div class="col col-6 col-lg-6">
        <a href="https://literatura.wroclaw.pl" class="site-wrap lit" target="_blank">
          <img class="placeholder d-none d-lg-block" src="<?php echo get_template_directory_uri(); ?>/images/literatura.png" alt="logo Wrocławski dom literatury">
          <div class="text-wrap">
